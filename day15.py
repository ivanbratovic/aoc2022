...
def main():
    ...
    for sensor, beacon, d in coords:
        ...
        min_point = (min(min_point[0], sensor[0], beacon[0]), min(min_point[1], sensor[1], beacon[1]))
        max_point = (max(max_point[0], sensor[0], beacon[0]), max(max_point[1], sensor[1], beacon[1]))
